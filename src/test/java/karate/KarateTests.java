...
import be.digitcom.streams.StreamsGuideApplication;
import com.intuit.karate.junit5.Karate;
import org.springframework.boot.test.context.SpringBootTest;

@SpringBootTest(webEnvironment = SpringBootTest.WebEnvironment.DEFINED_PORT, classes = {StreamsGuideApplication.class})
class KarateTests {
